...
navRightBtns.forEach((n) => {
	...
	n.addEventListener("click", (e) => {
		if (n.dataset.id == "login") {
			location.href = "https://hrk118cb-8080.use2.devtunnels.ms/auth";
...
articleBtns.forEach((b) => {
	b.addEventListener("click", (e) => {
		...
		if (b == "signup") {
			...
			location.href = "https://hrk118cb-8080.use2.devtunnels.ms/taskmanager";
		} else if (b == "tm") {
			location.href = "https://hrk118cb-8080.use2.devtunnels.ms/taskmanager";
		} else if (b == "nw") {
			location.href = "https://hrk118cb-8080.use2.devtunnels.ms/network";
		}
	})
